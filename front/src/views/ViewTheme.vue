    ...
    <div>
        ...
        <div class="w3-card-4" style="width: 80%; margin: 35px auto">
            ...
            <div class="w3-container" style="display: flex">
                ...
                <div style="flex-grow: 1; border-right: 1px solid #999999; height: 100px">
                    ...
                    <p>{{ theme.date }} by <b>{{theme.username}}</b></p>
                </div>
            ...
            <p>  <span style="color: blue">{{theme.likes}}</span> <i class="fa fa-arrow-alt-circle-up" style="font-size:20px;color:blue"></i> | <i class="fa fa-arrow-alt-circle-down" style="font-size:20px;color:black"></i> <span style="color: black">{{theme.dislikes}}</span>   </p>
        ...
        <div class="div" style="display: flex; padding: 5px" v-for="com in comments.slice().reverse()" :key="com.id">
            ...
            <div style="flex-grow: 5; display: flex; flex-direction: column">
                ...
                <div style="flex-grow: 1">
                    <p>  <span style="color: blue">{{com.likes}}</span> <i class="fa fa-arrow-alt-circle-up" style="font-size:20px;color:blue"></i> | <i class="fa fa-arrow-alt-circle-down" style="font-size:20px;color:black"></i> <span style="color: black">{{com.dislikes}}</span>   </p>
                </div>
            </div>
